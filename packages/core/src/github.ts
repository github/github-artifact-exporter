...
export type ListIssueCommentsQueryVariables = Exact<{
  id: Scalars["ID"];
  per_page?: Maybe<Scalars["Int"]>;
  after?: Maybe<Scalars["String"]>;
}>;

export type ListIssueCommentsQuery = { __typename?: "Query" } & {
  node?: Maybe<
    | { __typename?: "AddedToProjectEvent" }
    | { __typename?: "App" }
    | { __typename?: "AssignedEvent" }
        ...
        Array<
          Maybe<
            ...
            | ({ __typename?: "Issue" } & Pick<
                ...
                | "closedAt"
              > & {
                  assignees: { __typename?: "UserConnection" } & {
                    nodes?: Maybe<
                      Array<
                        Maybe<{ __typename?: "User" } & Pick<User, "login">>
                      >
                    >;
                  };
                  author?: Maybe<
